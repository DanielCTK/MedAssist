...
# ==============================================================================
# Chúng ta vẫn giữ decorator, nhưng sẽ truyền trực tiếp class này vào load_model
...
# ==============================================================================
# 4. LOAD MÔ HÌNH (ĐÃ SỬA LỖI TẠI ĐÂY)
# ==============================================================================
...
def load_ai_model():
    ...
    try:
        ...
        # --- SỬA LỖI CHÍNH: TRUYỀN TRỰC TIẾP custom_objects ---
        # Cách này ép TensorFlow dùng class CategoricalFocalLoss mà ta định nghĩa ở trên
        # bất kể file model lưu tên gì.
        ...
        # Không raise error để app không bị crash ngay lập tức, nhưng sẽ báo lỗi khi gọi API
        model = None
